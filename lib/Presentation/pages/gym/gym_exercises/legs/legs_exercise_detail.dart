                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          spacing: 8,
                          children: [
                            _muscleChip(context, 'Quadriceps'),
                            _muscleChip(context, 'Hamstrings'),
                            _muscleChip(context, 'Glutes'),
                            _muscleChip(context, 'Calves'),
                          ],
                        ),
                        const SizedBox(height: 20),
                        ...
                        Container(
                          ...
                          child: Text('Barbell, Squat Rack', style: TextStyle(color: context.textColor, fontSize: 14)),
                        ),
                        const SizedBox(height: 20),
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              _instructionItem(context, '2', 'Lower your body as if sitting back'),
                              _instructionItem(context, '3', 'Keep your chest up and back straight'),
                              _instructionItem(context, '4', 'Push through heels to return to start'),
                            ],
                          ),
                        ),
                        const SizedBox(height: 20),
