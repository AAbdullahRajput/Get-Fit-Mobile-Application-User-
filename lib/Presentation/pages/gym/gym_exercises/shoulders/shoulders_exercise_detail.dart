...
class ShouldersExerciseDetail extends StatefulWidget {
  final Map<String, dynamic> exercise;
  const ShouldersExerciseDetail({super.key, required this.exercise});

  @override
  State<ShouldersExerciseDetail> createState() => _ShouldersExerciseDetailState();
}

class _ShouldersExerciseDetailState extends State<ShouldersExerciseDetail> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          spacing: 8,
                          children: [
                            _muscleChip(context, 'Anterior Deltoid'),
                            _muscleChip(context, 'Lateral Deltoid'),
                            _muscleChip(context, 'Posterior Deltoid'),
                        ...
                        Container(
                          ...
                          child: Text('Dumbbells / Barbell', style: TextStyle(color: context.textColor, fontSize: 14)),
                        ),
                        const SizedBox(height: 20),
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              _instructionItem(context, '1', 'Stand with feet shoulder-width apart, dumbbells at shoulder height'),
                              _instructionItem(context, '2', 'Press the weights directly overhead until arms are fully extended'),
                              _instructionItem(context, '3', 'Pause briefly at the top, keeping core tight'),
                              _instructionItem(context, '4', 'Lower slowly back to shoulder level and repeat'),
                            ],
                          ),
                        ),
                        const SizedBox(height: 20),
