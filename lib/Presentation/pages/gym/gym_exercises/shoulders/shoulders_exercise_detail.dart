...
class _ShouldersExerciseDetailState extends State<ShouldersExerciseDetail> {
  ...
  void _markSetDone() {
    ...
    SupabaseService.logGymSet(
      ...
      category: widget.exercise['category'] ?? 'Shoulders',
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          _detailChip(context, 'Duration', widget.exercise['duration'] ?? ''),
                          const SizedBox(width: 12),
                          _detailChip(context, 'Kcal', widget.exercise['kcal'] ?? ''),
                          const SizedBox(width: 12),
  ...
  Widget _buildMuscles() {
    ...
    if (muscles.isEmpty) muscles = ['Anterior Deltoid', 'Lateral Deltoid', 'Posterior Deltoid', 'Trapezius'];
    ...
    return Column(children: [
      ...visibleSteps.map((step) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(color: context.cardBgColor, borderRadius: BorderRadius.circular(14)),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              ClipRRect(
                ...
                child: Image.network(imgUrl,
                    ...
                    loadingBuilder: (_, child, progress) => progress == null ? child
                        : Container(height: 180, color: context.cardBgColor,
                            child: Center(child: CircularProgressIndicator(color: _accent(context), strokeWidth: 2))),
                    errorBuilder: (_, __, ___) => Container(
                        height: 100, color: context.cardBgColor,
...
class _SuccessSheet extends StatelessWidget {
  final String title;
  final int totalSets, totalCalories, totalSeconds;
  const _SuccessSheet({
    required this.title,
