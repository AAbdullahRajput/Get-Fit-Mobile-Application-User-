...
class ShouldersExerciseDetail extends StatelessWidget {
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _muscleChip(context, 'Rotator Cuff'),
                            _muscleChip(context, 'Serratus Anterior'),
                          ],
                        ),
                        const SizedBox(height: 20),
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              _instructionItem(context, '1', 'Stand with feet shoulder-width apart'),
                              _instructionItem(context, '2', 'Press the weight overhead with control'),
                              _instructionItem(context, '3', 'Lower the weight back to shoulder level'),
