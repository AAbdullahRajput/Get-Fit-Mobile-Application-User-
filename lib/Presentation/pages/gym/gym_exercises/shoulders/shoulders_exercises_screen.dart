...
class _ShouldersExercisesScreenState extends State<ShouldersExercisesScreen> {
  ...
  List<Exercise> get shouldersExercises {
    return dummyExercises.where((e) => e.category == 'Shoulders').toList();
  }
  ...
  Widget _buildList(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemCount: shouldersExercises.length,
      itemBuilder: (context, index) {
        final exercise = shouldersExercises[index];
        return Padding(
